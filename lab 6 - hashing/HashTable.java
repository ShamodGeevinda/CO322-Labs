...
public class HashTable {
    private Element [] entryList;   //creating an array of entry objects
    ...
    public HashTable(int capacity){
        ...
        this.entryList=new Element[capacity];  
        this.currentSize=0;
    ...
    public void clearAll(){
        this.entryList=new Element[capacity];   //creating a new entry list
    ...
    public boolean isFull(){
        return currentSize==capacity;   //return 1 if it is full (else 0)
    }
    ...
    public void insert(int key,String value){
        ...
        if(containsKey(key)==true){
            return ;                        //if the key is already in the table ,return from the insert function

        }

        Element entryToInsert=new Element(key,value);   //create a new entry
        int h1=hash1(key);                              //evaluate the hash function 1

        int iteration=1;                                //assign 1 to the iteration
    ...
    public String get(int key){
        ...
        try{
            ...
            Element readEntry=entryList[h1]; //get the corresponding entry after hash1
    ...
    public void remove(int key){
        ...
        Element readEntry=entryList[h1]; //get the corresponding entry
        ...
        while(readEntry!=null && (readEntry.getKey()!=key)){  
            ...
            iteration=iteration+1; //increment the iterator by 1
